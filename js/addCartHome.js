...
const overlayAddHome = document.querySelector('.overlayAddHome');
document.querySelectorAll('.containerProduct').forEach(item => {
    ...
    containerView.addEventListener('click', () => {
        ...
        overlayAddHome.classList.add('active');
        document.body.classList.add('activeAdd');

        overlayAddHome.addEventListener('click', () => {
            overlayAddHome.classList.remove('active');
    ...
    addToCartHome.addEventListener('click', (e) => {
        ...
        setTimeout(() => {
            ...
            if (existItem !== -1) {
                ...
                const cartItem = cartbox.querySelectorAll('.cartItem');
